...
describe "As the site owner, I want to add a portfolio item so that I can show off my work" do
 it"adding a new project" do
    visit projects_path
  ...
  #  it "new project has invalid data" do
